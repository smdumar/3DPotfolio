...
//-----------------------------------------circular text scrolling animation-------------------
...
class ParallaxCard {
  constructor(cardEl) {
    this.cardEl = cardEl;
    this.imageWrapper = cardEl.querySelector(
  ...
  update() {
    ...
    const offset = this.heightDiff * progress * -0.5;
    this.imageWrapper.style.transform = `translate(0, ${offset}px)`;
  }
}

function initCardParallax() {
  const cardEls = document.querySelectorAll(".portfolioSection-card");
...
$(document).ready(function () {
  $(".aboutMe-numberCounts-counter").counterUp({
    delay: 10,
    time: 1000,
  });
});
